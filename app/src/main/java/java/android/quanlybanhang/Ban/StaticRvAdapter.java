...
public class StaticRvAdapter extends RecyclerView.Adapter<StaticRvAdapter.StaticRvHolderBan> {
    ...
    public StaticRvAdapter(ArrayList<StaticBanModel> staticBanModels, DanhSachChonBan danhSachChonBan, ArrayList<StaticModelKhuVuc> items, String Id_khuvuc,String trangthaistatic,String id_shop){
