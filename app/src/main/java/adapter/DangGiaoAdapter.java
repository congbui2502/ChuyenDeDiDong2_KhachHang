...
public class DangGiaoAdapter extends ArrayAdapter<DonHang> {
    ...
    public DangGiaoAdapter(Activity context, int layout, ArrayList<DonHang> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view = context.getLayoutInflater().inflate(R.layout.activity_don_giao, parent, false);
